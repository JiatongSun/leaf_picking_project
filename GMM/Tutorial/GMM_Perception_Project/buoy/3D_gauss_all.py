...
parameters_o = np.load('parameters_o.npy',allow_pickle=True)
weights_g = np.load('weights_g.npy')
parameters_g = np.load('parameters_g.npy',allow_pickle=True)
weights_y = np.load('weights_y.npy')
parameters_y = np.load('parameters_y.npy',allow_pickle=True)
